...
-- hl.bind("SUPER CTRL, " .. key, 'exec hyprctl dispatch submap workspaceset' .. N .. ' && notify-send -e -i ~/Pictures/icons/hyprland.icon "Hyprland" "Using the ' .. N .. 'rd set of extra workspaces"')
	hl.bind("SUPER+CTRL+ " .. key, function()
		hl.dispatch(hl.dsp.submap("workspaceset" .. N))
		hl.dispatch(hl.dsp.exec_cmd("notify-send -e -i ~/Pictures/icons/hyprland.icon 'Hyprland' 'Using the " .. N .. "rd set of extra workspaces'"))
	end)
...
hl.define_submap("workspaceset" .. N, function()
	...
	hl.bind("SUPER+CTRL+ " .. key, function()
		...
		hl.dispatch(hl.dsp.exec_cmd("notify-send -e -i ~/Pictures/icons/hyprland.icon 'Hyprland' 'Using the normal set of workspaces'"))
	end)
end)
