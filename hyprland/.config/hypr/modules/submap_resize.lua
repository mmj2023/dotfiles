-- hl.bind("SUPER+CTRL+ R", hl.dispatch(hl.dsp.exec_cmd([[hyprctl dispatch submap resize && notify-send -e -h string:x-canonical-private-synchronous:osd -i ~/Pictures/icons/hyprland.icon "Hyprland" "Started Resize mode"]])))
hl.bind("SUPER+CTRL+ R", function()
	-- hl.dispatch(hl.dsp.focus({ workspace = 2 }))
	-- hl.dsp.focus({ workspace = 2 })
	-- hl.dispatch(hl.dsp.exec_cmd(RqtBrw))
    hl.dispatch(hl.dsp.exec_cmd("notify-send -e -i ~/Pictures/icons/hyprland.icon 'Hyprland' 'Started Resize mode'"))
